...
/**
 * @param {number[]} a       – first data series
...
/**
 * @param {number[]} a       – first data series
 * @param {number[]} b       – second data series
 ...
 *
 * @param {number[]} arr        – source data series
 * @param {number}   targetLen  – desired output length
 * @returns {number[]}          – resampled array of length targetLen
 */
...
/**
 * @param {Array<{ts:number, watts:number}>} trace  – power trace to extract from
 * @returns {number[]}  – array of watt values only
 */
 ...
 *
 * @param {Array<{ts:number, watts:number}>} trace  – power trace to integrate
 ...
 *
 * @param {number[]} arr  – source data series
 * @returns {number[]}  – normalised values in [0, 1]
 */
